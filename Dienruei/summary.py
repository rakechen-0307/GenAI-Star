...
if __name__ == "__main__":
    ...
    Please split out appropriate and correct timelines and present the corresponding summary in table format, highly correlated with the change of scores and page-turner scene.
